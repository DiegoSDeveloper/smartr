...
export const defaultConfig = {
  ...
  behavior: {
    ...
    select: {
      ...
      // Async select (loadOptions) defaults
      pageSize: 20,
      searchDebounceMs: 300,
      minSearchLength: 0,
      loadOnOpen: true,
      fastSearchMinSearchLength: 1,
      fastSearchLoadOnOpen: false,
    },
  ...
  components: {
    ...
    table: {
      ...
      icons: {
        ...
        previousPage: "fas fa-angle-left",
    ...
    select: {
      classes: {
        ...
        optionsRetry: "options-retry",
        optionsSentinel: "options-sentinel",
      ...
      texts: {
        ...
        loadErrorText: "Failed to load options",
        retryText: "Retry",
        minSearchText: "Type at least %s1 characters to search",
      },
    },
    ...
    editor: {
      classes: {
        ...
        input: "form-control",
        inputLabel: "form-control-plaintext",
